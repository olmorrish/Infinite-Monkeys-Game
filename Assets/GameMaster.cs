...
public class GameMaster : MonoBehaviour {
    ...
    public void RegisterMonkeyKeyHit(char hitKey, Monkey monkey) {
        ...
        if (hitKey == theEntiretyOfKingLear[learTileGoalIndex] && allLearTiles.Count > 0) {
    ...
    public void SpawnLearTile() {
        if (learTileSpawnIndex < theEntiretyOfKingLear.Length) {
